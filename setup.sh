...
sudo apt update
sudo apt upgrade -y
sudo apt install -y xfce4 xfce4-panel-profiles xfce4-power-manager libfuse2
sudo apt install -y bat vim htop rofi curl cmake brightnessctl flameshot xclip redshift ntfs-3g vlc gvfs-backends
# To use the trackpad
